...
const defs = {
  buildings: {
    ...
    allianceDepot:{name:'Allianzdepot', desc:'Lagerplatz für Ressourcen, die der Allianz zur Verfügung gestellt werden.', base:{limestone:30000, gold:30000, phosphate:5000}, requires:{shipyard:3}, facility:true},
    missileSilo:{name:'Raketensilo', desc:'Lagert und startet interplanetare Raketen zum Fernangriff auf gegnerische Verteidigung.', base:{iron:30000, sulfur:11000}, requires:{shipyard:1}, facility:true},
    sensorPhalanx:{name:'Sensorphalanx', desc:'Ermöglicht die Überwachung fremder Systeme von einem Mond aus.', base:{copper:30000, silver:35000, naturalGas:15000}, requires:{naniteFactory:1}, moonOnly:true, facility:true},
    jumpGate:{name:'Sprungtor', desc:'Verbindet zwei eigene Monde für verzögerungsfreien Flottentransfer.', base:{aluminium:2000000, lithium:3500000, uranium:1300000}, requires:{naniteFactory:1, hyperspaceTech:7}, moonOnly:true, facility:true},
    lunarBase:{name:'Lunarbasis', desc:'Grundlegende Infrastruktur auf einem Mond, Voraussetzung für weitere Mondgebäude.', base:{limestone:40000, aluminium:40000}, requires:{}, moonOnly:true, facility:true},
    missileLauncher:{name:'Raketenwerfer', desc:'Einfache, günstige Verteidigungsanlage mit solidem Grundschutz.', base:{iron:1400, sulfur:600}, isDefense:true, attack:80, shield:20, hull:2000, requires:{shipyard:1}},
    lightLaser:{name:'Leichtes Laser-Geschütz', desc:'Leichte Laserkanone mit ausgewogenem Verhältnis aus Kosten und Feuerkraft.', base:{iron:1300, silver:700}, isDefense:true, attack:100, shield:25, hull:2000, requires:{shipyard:2, energyTech:1}},
    heavyLaser:{name:'Schweres Laser-Geschütz', desc:'Schwere Laserkanone mit deutlich mehr Angriffskraft.', base:{iron:5500, silver:2500}, isDefense:true, attack:250, shield:100, hull:8000, requires:{shipyard:4, energyTech:3}},
    gaussCannon:{name:'Gauß-Kanone', desc:'Schweres Railgun-Geschütz mit hoher Durchschlagskraft, teuer aber effektiv.', base:{iron:22000, silver:11000, naturalGas:4000}, isDefense:true, attack:1100, shield:200, hull:35000, requires:{shipyard:6, weaponsTech:3, shieldingTech:1, energyTech:6}},
    ionCannon:{name:'Ionenkanone', desc:'Spezialisiert auf hohe Schildwerte - schwer zu durchdringen.', base:{aluminium:5000, lithium:3000}, isDefense:true, attack:150, shield:500, hull:8000, requires:{shipyard:4, ionTech:4}},
    plasmaTurret:{name:'Plasmawerfer', desc:'Stärkste konventionelle Verteidigungsanlage mit enormer Feuerkraft.', base:{aluminium:60000, rareEarths:45000, uranium:25000}, isDefense:true, attack:3000, shield:300, hull:100000, requires:{shipyard:8, plasmaTech:7}},
    smallShield:{name:'Kleine Schildkuppel', desc:'Errichtet einen Schutzschild um den gesamten Planeten (nur einmal baubar).', base:{aluminium:12000, silver:8000}, isDefense:true, unique:true, attack:1, shield:2000, hull:20000, requires:{shieldingTech:2}},
    largeShield:{name:'Große Schildkuppel', desc:'Mächtiger Schutzschild mit deutlich höherer Kapazität als die kleine Schildkuppel (nur einmal baubar).', base:{aluminium:60000, silver:40000}, isDefense:true, unique:true, attack:1, shield:10000, hull:100000, requires:{shipyard:6, shieldingTech:6}},
    interplanetaryMissile:{name:'Interplanetare Rakete', desc:'Einweg-Fernwaffe gegen gegnerische Verteidigung in Reichweite des Raketensilos.', base:{iron:10000, sulfur:5000}, isDefense:true, attack:12000, shield:0, hull:1, requires:{missileSilo:4}},
  },
  research: {
    energyTech:{name:'Energietechnik', desc:'Grundlagentechnologie für effizientere Energiegewinnung, Voraussetzung für viele weitere Forschungen.', base:{silver:700, uranium:500}, requires:{researchLab:1}},
    combustion:{name:'Verbrennungstriebwerk', desc:'Verbessert konventionelle Schiffsantriebe.', base:{iron:400, crudeOil:600}, requires:{researchLab:1, energyTech:1}},
    computerTech:{name:'Computertechnik', desc:'Erhöht die maximale Anzahl gleichzeitiger Flottenbewegungen und ist Grundlage für viele Technologien.', base:{lithium:600, naturalGas:400}, requires:{researchLab:1}},
    weaponsTech:{name:'Waffentechnik', desc:'Erhöht die Angriffskraft aller Schiffe und Verteidigungsanlagen.', base:{iron:700, silver:300}, requires:{researchLab:4}},
    shieldingTech:{name:'Schildtechnik', desc:'Erhöht die Schildstärke aller Schiffe und Verteidigungsanlagen.', base:{aluminium:250, silver:550}, requires:{researchLab:6, energyTech:3}},
    espionageTech:{name:'Spionagetechnik', desc:'Verbessert Spionageberichte und die Erfolgschance bei Forschungsdiebstahl.', base:{copper:300, lithium:800, naturalGas:300}, requires:{researchLab:3}},
    impulseDrive:{name:'Impulstriebwerk', desc:'Schnellerer Antrieb für mittelschwere Schiffe.', base:{aluminium:2000, lithium:3600, crudeOil:1000}, requires:{researchLab:2, energyTech:1}},
    armourTech:{name:'Rumpfpanzerung', desc:'Erhöht die Hüllenstärke aller Schiffe und Verteidigungsanlagen.', base:{iron:700, nickel:300}, requires:{researchLab:2}},
    hyperspaceTech:{name:'Hyperraumtechnik', desc:'Grundlage für Hyperraumantrieb und weitere fortschrittliche Technologien.', base:{rareEarths:4000, uranium:2000}, requires:{researchLab:7, energyTech:5, shieldingTech:5}},
    hyperspaceDrive:{name:'Hyperraumantrieb', desc:'Schnellster verfügbarer Antrieb für große Kriegsschiffe.', base:{aluminium:10000, rareEarths:18000, uranium:8000}, requires:{researchLab:7, hyperspaceTech:3}},
    laserTech:{name:'Lasertechnik', desc:'Grundlage für Laserwaffen und weiterführende Waffentechnologien.', base:{copper:180, silver:120}, requires:{researchLab:1, energyTech:2}},
    ionTech:{name:'Iontechnik', desc:'Grundlage für Ionenwaffen und -verteidigung.', base:{aluminium:800, lithium:400, naturalGas:200}, requires:{researchLab:4, laserTech:5, energyTech:4}},
    plasmaTech:{name:'Plasmatechnik', desc:'Grundlage für Plasmawaffen, die stärkste konventionelle Waffentechnologie.', base:{aluminium:2000, rareEarths:4200, uranium:800}, requires:{researchLab:4, energyTech:8, laserTech:10, ionTech:5}},
    ...
    astrophysics:{name:'Astrophysik', desc:'Erhöht die maximale Anzahl an Kolonien und gleichzeitigen Expeditionen.', base:{aluminium:5000, lithium:7000, crudeOil:4000}, requires:{researchLab:3, espionageTech:4, impulseDrive:3}},
    intergalacticNetwork:{name:'Intergalaktisches Forschungsnetzwerk', desc:'Beschleunigt die Forschung durch ein Netzwerk verbundener Forschungslabore.', base:{aluminium:250000, rareEarths:400000, naturalGas:150000}, requires:{researchLab:10, computerTech:8}},
  },
  ships: {
    smallCargo:{name:'Kleiner Transporter', desc:'Günstiger Transporter für kleinere Ladungen.', cost:{iron:2500, aluminium:1500}, cargo:5000, speed:1, fuel:12, attack:5, shield:10, hull:4000, role:'cargo', requires:{shipyard:2}},
    largeCargo:{name:'Großer Transporter', desc:'Transporter mit deutlich größerer Ladekapazität.', cost:{iron:7500, aluminium:4500}, cargo:25000, speed:0.8, fuel:28, attack:5, shield:25, hull:12000, role:'cargo', requires:{shipyard:4}},
    colonyShip:{name:'Kolonieschiff', desc:'Wird für die Gründung neuer Kolonien benötigt.', cost:{aluminium:15000, lithium:15000, crudeOil:10000}, cargo:7500, speed:0.6, fuel:60, attack:0, shield:100, hull:30000, role:'colony', requires:{shipyard:4, combustion:3}},
    espionageProbe:{name:'Spionagesonde', desc:'Günstige, schnelle Sonde für Spionagemissionen.', cost:{lithium:1000}, cargo:5, speed:3, fuel:1, attack:0, shield:0, hull:1000, role:'probe', requires:{shipyard:3, combustion:3}},
    lightFighter:{name:'Leichter Jäger', desc:'Günstiges Kampfschiff für frühe Angriffe.', cost:{iron:3000, aluminium:1000}, cargo:50, speed:1.4, fuel:20, attack:50, shield:10, hull:4000, role:'combat', requires:{shipyard:1, combustion:1}},
    heavyFighter:{name:'Schwerer Jäger', desc:'Robusteres Kampfschiff mit mehr Feuerkraft als der leichte Jäger.', cost:{iron:6000, aluminium:3000, copper:1000}, cargo:100, speed:1.0, fuel:25, attack:150, shield:25, hull:10000, role:'combat', requires:{shipyard:3, armourTech:2, impulseDrive:2}},
    cruiser:{name:'Kreuzer', desc:'Vielseitiges Kampfschiff, effektiv gegen leichte Jäger.', cost:{iron:18000, aluminium:8000, crudeOil:3000}, cargo:800, speed:1.1, fuel:40, attack:400, shield:50, hull:27000, role:'combat', requires:{shipyard:5, weaponsTech:2}},
    battleship:{name:'Schlachtschiff', desc:'Schweres Kampfschiff mit hoher Feuerkraft und Hülle.', cost:{iron:42000, aluminium:18000}, cargo:1500, speed:0.8, fuel:50, attack:1000, shield:200, hull:60000, role:'combat', requires:{shipyard:7, hyperspaceDrive:4}},
    battlecruiser:{name:'Großer Kreuzer', desc:'Spezialisiert auf die Bekämpfung von Verteidigungsanlagen.', cost:{aluminium:35000, lithium:35000, crudeOil:15000}, cargo:750, speed:0.9, fuel:250, attack:700, shield:400, hull:70000, role:'combat', requires:{shipyard:8, hyperspaceTech:5, laserTech:12}},
    bomber:{name:'Bomber', desc:'Spezialisiert auf die Zerstörung feindlicher Verteidigungsanlagen.', cost:{iron:50000, aluminium:25000, crudeOil:15000}, cargo:500, speed:0.6, fuel:65, attack:1000, shield:500, hull:75000, role:'combat', requires:{shipyard:8, plasmaTech:5, impulseDrive:6}},
    destroyer:{name:'Zerstörer', desc:'Schweres Kampfschiff, besonders effektiv gegen Bomber.', cost:{iron:65000, aluminium:45000, crudeOil:15000}, cargo:2000, speed:0.7, fuel:100, attack:2000, shield:500, hull:110000, role:'combat', requires:{shipyard:9, hyperspaceTech:5, hyperspaceDrive:6}},
    reaper:{name:'Reaper', desc:'Elite-Kampfschiff mit enormer Feuerkraft und Hülle.', cost:{iron:85000, aluminium:50000, rareEarths:25000}, cargo:10000, speed:0.6, fuel:80, attack:2800, shield:700, hull:140000, role:'combat', requires:{shipyard:10, spaceDock:1, hyperspaceTech:6, hyperspaceDrive:7}},
    pathfinder:{name:'Pfadfinder', desc:'Schnelles, vielseitiges Schiff mit hoher Ladekapazität.', cost:{aluminium:10000, lithium:14000, crudeOil:7000}, cargo:10000, speed:1.6, fuel:20, attack:200, shield:100, hull:23000, role:'combat', requires:{shipyard:5, spaceDock:1, hyperspaceDrive:2, hyperspaceTech:3}},
    deathstar:{name:'Todesstern', desc:'Die mächtigste Waffe im Universum - extrem teuer und stark.', cost:{iron:4000000, aluminium:3000000, rareEarths:2000000, uranium:1000000}, cargo:1000000, speed:0.4, fuel:1, attack:200000, shield:50000, hull:9000000, role:'combat', requires:{shipyard:12, hyperspaceTech:6, gravitonTech:1}},
    ...
    recycler:{name:'Recycler', desc:'Sammelt Trümmerfelder nach Schlachten ein.', cost:{iron:11000, aluminium:5000, crudeOil:2000}, cargo:20000, speed:0.7, fuel:30, attack:1, shield:10, hull:16000, role:'recycler', requires:{shipyard:4, combustion:6}},
    researchProbe:{name:'Forschungssonde', desc:'Baugleich mit der Spionagesonde, ermöglicht aber bei Spionage gegen NPC-Kolonien den Diebstahl fremder Forschung.', cost:{lithium:1000}, cargo:5, speed:3, fuel:1, attack:0, shield:0, hull:1000, role:'research', requires:{shipyard:3, combustion:3}},
  },
  items: {
